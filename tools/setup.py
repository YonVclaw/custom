...
def main():
    ...
    print("""
  ######################################
  # X1X Development Environment Setup #
  ######################################

  This script will create your X1X dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your X1X project folder:
    [Arma 3 installation directory]\\{} => X1X project folder
    P:\\{}                              => X1X project folder
